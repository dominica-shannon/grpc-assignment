...
public final class EmployeeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.employee.grpc.Employee.EmployeeRequest,
      com.employee.grpc.Employee.EmployeeResponse> getGetEmployeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getEmployee",
      requestType = com.employee.grpc.Employee.EmployeeRequest.class,
      responseType = com.employee.grpc.Employee.EmployeeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.employee.grpc.Employee.EmployeeRequest,
      com.employee.grpc.Employee.EmployeeResponse> getGetEmployeeMethod() {
    io.grpc.MethodDescriptor<com.employee.grpc.Employee.EmployeeRequest, com.employee.grpc.Employee.EmployeeResponse> getGetEmployeeMethod;
      ...
      synchronized (EmployeeServiceGrpc.class) {
        if ((getGetEmployeeMethod = EmployeeServiceGrpc.getGetEmployeeMethod) == null) {
          EmployeeServiceGrpc.getGetEmployeeMethod = getGetEmployeeMethod = 
              io.grpc.MethodDescriptor.<com.employee.grpc.Employee.EmployeeRequest, com.employee.grpc.Employee.EmployeeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "EmployeeService", "getEmployee"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.employee.grpc.Employee.EmployeeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.employee.grpc.Employee.EmployeeResponse.getDefaultInstance()))
  ...
  public static abstract class EmployeeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getEmployee(com.employee.grpc.Employee.EmployeeRequest request,
        io.grpc.stub.StreamObserver<com.employee.grpc.Employee.EmployeeResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.employee.grpc.Employee.EmployeeRequest,
                com.employee.grpc.Employee.EmployeeResponse>(
  ...
  public static final class EmployeeServiceBlockingStub extends io.grpc.stub.AbstractStub<EmployeeServiceBlockingStub> {
    ...
    /**
     */
    public com.employee.grpc.Employee.EmployeeResponse getEmployee(com.employee.grpc.Employee.EmployeeRequest request) {
  ...
  public static final class EmployeeServiceFutureStub extends io.grpc.stub.AbstractStub<EmployeeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.employee.grpc.Employee.EmployeeResponse> getEmployee(
        com.employee.grpc.Employee.EmployeeRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EMPLOYEE:
          serviceImpl.getEmployee((com.employee.grpc.Employee.EmployeeRequest) request,
              (io.grpc.stub.StreamObserver<com.employee.grpc.Employee.EmployeeResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EmployeeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.employee.grpc.Employee.getDescriptor();
    }
